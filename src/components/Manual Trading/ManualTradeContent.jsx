    ...
    <div className="w-full h-auto md:h-[95%] px-8 md:px-0 py-2 my-2">
      ...
      <div className="h-full 2xl:h-[450px] w-[98%] mx-auto my-10 bg-slate-50 rounded-lg shadow-md">
        ...
        <div className="flex h-[50px] w-full gap-2 justify-between mb-3">
          <div
            className={`flex justify-center items-center w-[50%] cursor-pointer text-blue-500 ${currentTab === "Order Type One"
          ...
          <div
            className={`flex justify-center items-center w-[50%] cursor-pointer ${currentTab === "Order Type Two"
                ? "border-b-2 border-b-blue-500"
                : "border-none"
              }`}
